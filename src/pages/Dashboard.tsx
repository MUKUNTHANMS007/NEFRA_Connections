  ...
  if (loading) {
    return (
      <div className="flex min-h-[60vh] items-center justify-center">
        <p className="font-mono text-slate-300 animate-pulse text-xl">INITIALIZING_COMMAND_CENTER...</p>
      </div>
    );
  }
    ...
    <div className="w-full">
      <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          <div>
            <p className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-500 flex items-center gap-2 mb-2">
              <div className="h-px w-8 bg-white/10" /> System Verified
            </p>
            <h1 className="text-4xl font-black tracking-tight text-white sm:text-5xl">
              Welcome back, <span className="text-slate-200">{displayName}</span>
            </h1>
          </div>
          <Link
            to="/premium"
            className="inline-flex items-center gap-2 rounded-xl bg-white/10 border border-white/10 px-6 py-3 font-black tracking-widest text-[10px] uppercase text-white hover:bg-white/20 transition-colors"
          >
            <TrendingUp className="h-4 w-4 text-emerald-400" /> Upgrade Node Capacity
          </Link>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {/* Metric 1 */}
          <div className="relative group overflow-hidden rounded-[2rem] border border-white/10 bg-slate-900/40 p-8 hover:border-white/20 transition-colors">
            <div className="absolute top-0 right-0 p-6 opacity-20 group-hover:opacity-40 transition-opacity">
              <Eye className="h-16 w-16 text-indigo-300" />
            </div>
          ...
          {/* Metric 3 */}
          <div className="relative group overflow-hidden rounded-[2rem] border border-white/10 bg-slate-900/40 p-8 hover:border-white/20 transition-colors sm:col-span-2 lg:col-span-1">
            <div className="absolute top-0 right-0 p-6 opacity-20 group-hover:opacity-40 transition-opacity">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          {/* Quick Actions Panel */}
          <div className="lg:col-span-2 rounded-[2.5rem] border border-white/10 bg-slate-900/40 p-8 sm:p-10 shadow-2xl">
            <h2 className="text-xl font-black text-white mb-8">Command Modules</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              
              <Link to="/my-company/edit" className="group flex flex-col gap-4 rounded-2xl border border-white/10 bg-slate-950/40 p-6 hover:bg-white/5 hover:border-white/20 transition-all">
              ...
              <Link to="/post" className="group flex flex-col gap-4 rounded-2xl border border-white/10 bg-slate-950/40 p-6 hover:bg-white/5 hover:border-white/20 transition-all">
                <div className="h-12 w-12 rounded-full bg-white/5 flex items-center justify-center border border-white/10 group-hover:bg-white/10 transition-colors">
              ...
              <Link to="/settings" className="group flex flex-col gap-4 rounded-2xl border border-white/10 bg-slate-950/40 p-6 hover:bg-white/5 hover:border-white/20 transition-all sm:col-span-2">
          ...
          <div className="rounded-[2.5rem] border border-white/10 bg-slate-900/40 p-8 shadow-2xl flex flex-col">
            ...
            <Link to="/feed" className="mt-8 block text-center text-xs font-bold uppercase tracking-widest text-slate-300 hover:text-white transition-colors">
              View Full Log &rarr;
            </Link>
          </div>
